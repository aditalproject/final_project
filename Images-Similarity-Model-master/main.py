...
right_train, right_val, right_test, left_train, left_val,\
left_test, y_tr, y_val, y_test, l_tr, l_val, l_te = data_prep_perc(root)
...
sim = similarity_net(dp, bs, ep, lr,# hyper-parameters
                     l_tr, l_val, l_te,
                     right_train, right_val, right_test,
                     left_train, left_val, left_test,
                     im_to_vis=imgs, vis=1, plt_loss=0, plt_model=0)
